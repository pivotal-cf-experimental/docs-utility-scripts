...
if release then
	...
	puts `curl -X POST -H "X-TrackerToken: $TRACKERTOKEN" -H "Content-Type: application/json" -d '{"current_state":"unscheduled","estimate":1,"name":"New Stemcell(s)","description": "https://github.com/cloudfoundry/bosh-linux-stemcell-builder, https://github.com/cloudfoundry/bosh/release/"}' "https://www.pivotaltracker.com/services/v5/projects/923920/stories"`
else 
