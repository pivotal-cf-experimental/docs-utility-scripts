...
function doreplacement(text)
{
	...
	text = text.replace(/(\s[^`][A-Z]+[-_][A-Z\-]+\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Likely missing ` or code tags. %>');
	...
	text = text.replace(/(\b^(?!title:).*IPSec for PCF\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	text = text.replace(/(\b^(?!title:).*MySQL for Pivotal Platform\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	text = text.replace(/(\b^(?!title:).*Operations Manager\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	...
	text = text.replace(/(\b^(?!title:).*Pivotal Anti-Virus\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	...
	text = text.replace(/(\b^(?!title:).*Pivotal application service(?!\s\()(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.app_runtime %>');
	text = text.replace(/(\b^(?!title:).*Pivotal Backup and Restore\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	...
	text = text.replace(/(\b^(?!title:).*Pivotal Compliance Scanner\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	text = text.replace(/(\b^(?!title:).*Pivotal Concourse\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	text = text.replace(/(\b^(?!title:).*Pivotal CredHub Service Broker\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	text = text.replace(/(\b^(?!title:).*Pivotal Event Alerts\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	text = text.replace(/(\b^(?!title:).*Pivotal File Integrity Monitoring\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	text = text.replace(/(\b^(?!title:).*Pivotal GemFire\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_name %>');
	text = text.replace(/(\b^(?!title:).*Pivotal Greenplum\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	text = text.replace(/(\b^(?!title:).*Pivotal Healthwatch\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	text = text.replace(/(\b^(?!title:).*Pivotal IPsec\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	text = text.replace(/(\b^(?!title:).*Pivotal Isolation Segment\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	text = text.replace(/(\b^(?!title:).*Pivotal On Demand Services SDK\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	text = text.replace(/(\b^(?!title:).*Pivotal Ops Manager\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	...
	text = text.replace(/(\b^(?!title:).*Pivotal Postgres\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	text = text.replace(/(\b^(?!title:).*Pivotal Push Notification\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	text = text.replace(/(\b^(?!title:).*Pivotal RabbitMQ\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	text = text.replace(/(\b^(?!title:).*Pivotal Service Instance Manager\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	text = text.replace(/(\b^(?!title:).*Pivotal Single Sign-On\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	text = text.replace(/(\b^(?!title:).*Rabbit MQ\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_short %>');
	text = text.replace(/(\b^(?!title:).*RabbitMQ for Kubernetes\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	text = text.replace(/(\b^(?!title:).*RabbitMQ for Pivotal Platform\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	text = text.replace(/(\b^(?!title:).*Redis for Pivotal Platform\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	text = text.replace(/(\b^(?!title:).*single sign-on\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	...
	text = text.replace(/(\b^title:.*PAS\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Write "Pivotal Application Service" in full in topic titles. %>');
