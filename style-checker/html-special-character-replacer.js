...
text = text.replace(/(^\s*#{2,3}[\s\w](?!.*\<a id)\s*(?!(Features|Security Fix|Security Fixes|Resolved Issue|Resolved Issues|Known Issue|Known Issues|Compatibility|Packages)).*$)/gm,'$1 <%# Make H2 and H3 headers anchors unless the ToC is already over-sized. %>');
...
text = text.replace(/(\b^(?!title:).*MySQL for Pivotal Platform\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_name %>');
text = text.replace(/(\b^(?!title:).*Operations Manager\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_name %>');
text = text.replace(/(\b^(?!title:).*Ops Man\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_short %>');
text = text.replace(/(\b^(?!title:).*ops manager\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_short %>');
text = text.replace(/(\b^(?!title:).*OpsMan\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_short %>');
text = text.replace(/(\b^(?!title:).*OpsManager\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_short %>');
text = text.replace(/(\b^(?!title:).*PAS\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.app_runtime_abbr %>');
text = text.replace(/(\b^(?!title:).*PBS\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_short %>');
text = text.replace(/(\b^(?!title:).*PCF 3\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use "<%= vars.platform_name %> 3" %>');
text = text.replace(/(\b^(?!title:).*PCF Ops Manager\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_short %>');
text = text.replace(/(\b^(?!title:).*PCF Ops Manager\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_short %>');
text = text.replace(/(\b^(?!title:).*PCF Small Footprint\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_name %>');
text = text.replace(/(\b^(?!title:).*PCF v2.0 and later\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "<%= vars.platform_name %> (formerly <%= vars.platform_old %>)" is preferred. %>');
text = text.replace(/(\b^(?!title:).*PFS\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_short %>');
text = text.replace(/(\b^(?!title:).*Pivotal Anti-Virus\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_name %>');
text = text.replace(/(\b^(?!title:).*Pivotal App Service(?!\s\()(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.app_runtime %>');
text = text.replace(/(\b^(?!title:).*Pivotal app service(?!\s\()(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.app_runtime %>');
text = text.replace(/(\b^(?!title:).*Pivotal Application Service(?!\s\()(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.app_runtime %>');
text = text.replace(/(\b^(?!title:).*Pivotal application service(?!\s\()(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.app_runtime %>');
text = text.replace(/(\b^(?!title:).*Pivotal Backup and Restore\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_name %>');
text = text.replace(/(\b^(?!title:).*Pivotal Cloud Foundry\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= platform_old %>');
text = text.replace(/(\b^(?!title:).*Pivotal Cloud Foundry 3\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "<%= platform_name %> 3" is preferred. %>');
text = text.replace(/(\b^(?!title:).*Pivotal Compliance Scanner\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_name %>');
text = text.replace(/(\b^(?!title:).*Pivotal Concourse\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_name %>');
text = text.replace(/(\b^(?!title:).*Pivotal CredHub Service Broker\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_name %>');
text = text.replace(/(\b^(?!title:).*Pivotal Event Alerts\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_name %>');
text = text.replace(/(\b^(?!title:).*Pivotal File Integrity Monitoring\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_name %>');
text = text.replace(/(\b^(?!title:).*Pivotal GemFire\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_name %>');
text = text.replace(/(\b^(?!title:).*Pivotal Greenplum\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_name %>');
text = text.replace(/(\b^(?!title:).*Pivotal Healthwatch\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_name %>');
text = text.replace(/(\b^(?!title:).*Pivotal IPsec\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_name %>');
text = text.replace(/(\b^(?!title:).*Pivotal Isolation Segment\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_name %>');
text = text.replace(/(\b^(?!title:).*Pivotal On Demand Services SDK\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_name %>');
text = text.replace(/(\b^(?!title:).*Pivotal Ops Manager\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_name %>');
text = text.replace(/(\b^(?!title:).*Pivotal Platform v2.0 and later\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "<%= vars.platform_name %> (formerly <%= vars.platform_old %>)" is preferred. %>');
text = text.replace(/(\b^(?!title:).*Pivotal Postgres\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_name %>');
text = text.replace(/(\b^(?!title:).*Pivotal Push Notification\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_name %>');
text = text.replace(/(\b^(?!title:).*Pivotal RabbitMQ\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_name %>');
text = text.replace(/(\b^(?!title:).*Pivotal Service Instance Manager\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_name %>');
text = text.replace(/(\b^(?!title:).*Pivotal Single Sign-On\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_name %>');
text = text.replace(/(\b^(?!title:).*Rabbit MQ\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_short %>');
text = text.replace(/(\b^(?!title:).*RabbitMQ for Kubernetes\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_name %>');
...
text = text.replace(/(\bavailability zone(?!\s\()(?![^£]*\<%# ECS %\>))/gm,'$1<%# Shorten to "AZ" after the first use. %>');
text = text.replace(/(\bAvailability zone(?!\s\()(?![^£]*\<%# ECS %\>))/gm,'$1<%# Shorten to "AZ" after the first use. %>');
