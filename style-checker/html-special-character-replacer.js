...
function doreplacement(text)
{
	...
	text = text.replace(/(\seg\.\s(?![^£]*\<%# ECS %\>))/gm,'$1<%# "For example" is preferred. %>');
	text = text.replace(/(^(?!title:).*2012R2\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# The short product name is "<%= vars.windows_runtime_abbr %> 2012 R2". %>');
	text = text.replace(/(^(?!title:).*app runtime\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.app_runtime %>');
	text = text.replace(/(^(?!title:).*Beta\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "beta" is preferred. %>');
	text = text.replace(/(^(?!title:).*Elastic Runtime\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.app_runtime %>');
	text = text.replace(/(^(?!title:).*ERT\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.app_runtime %>');
	text = text.replace(/(^(?!title:).*IPSec for PCF\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	...
	text = text.replace(/(^(?!title:).*Pivotal Compliance Scanner\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	text = text.replace(/(^(?!title:).*Pivotal Concourse\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	text = text.replace(/(^(?!title:).*Pivotal CredHub Service Broker\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	text = text.replace(/(^(?!title:).*Pivotal Developer Console\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	text = text.replace(/(^(?!title:).*Pivotal Event Alerts\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	text = text.replace(/(^(?!title:).*Pivotal File Integrity Monitoring\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	text = text.replace(/(^(?!title:).*Pivotal GemFire\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_name %>');
	text = text.replace(/(^(?!title:).*Pivotal Greenplum\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	text = text.replace(/(^(?!title:).*Pivotal Healthwatch\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	...
	text = text.replace(/(^(?!title:).*Pivotal Service Instance Manager\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	text = text.replace(/(^(?!title:).*Pivotal Single Sign-On\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	text = text.replace(/(^(?!title:).*Rabbit MQ\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_short %>');
	text = text.replace(/(^(?!title:).*RabbitMQ for Kubernetes\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	text = text.replace(/(^(?!title:).*RabbitMQ for Pivotal Platform\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	text = text.replace(/(^(?!title:).*Redis for Pivotal Platform\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
	text = text.replace(/(^(?!title:).*single sign-on\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use <%= vars.product_full %>');
