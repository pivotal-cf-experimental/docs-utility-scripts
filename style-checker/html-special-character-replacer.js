...
function doreplacement(text)
{
	...
	text = text.replace(/(versions \<\= [\d\.]+)/gm,'$1 <%# "version # or earlier" is the preferred style. %>');
	text = text.replace(/(versions \>\= [\d\.]+)/gm,'$1 <%# "version # or earlier" is the preferred style. %>');
	...
	text = text.replace(/(\b0 and higher\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "0 and later" is preferred. %>');
	text = text.replace(/(\b0 and lower\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "0 and earlier" is preferred. %>');
	text = text.replace(/(\b0 GB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "0&nbsp;GB" is preferred. %>');
	text = text.replace(/(\b0 KB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "0&nbsp;KB" is preferred. %>');
	text = text.replace(/(\b0 MB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "0&nbsp;MB" is preferred. %>');
	text = text.replace(/(\b0 or above\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "0 or later" is preferred. %>');
	text = text.replace(/(\b0 or below\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "0 or earlier" is preferred. %>');
	text = text.replace(/(\b0 or greater\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "0 or later" is preferred. %>');
	text = text.replace(/(\b0 or higher\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "0 or later" is preferred. %>');
	text = text.replace(/(\b0 or lower\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "0 or earlier" is preferred. %>');
	text = text.replace(/(\b0GB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "0&nbsp;GB" is preferred. %>');
	text = text.replace(/(\b0KB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "0&nbsp;KB" is preferred. %>');
	text = text.replace(/(\b1 and above\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "1 and later" is preferred. %>');
	text = text.replace(/(\b1 and below\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "1 and earlier" is preferred. %>');
	text = text.replace(/(\b1 and greater\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "1 and later" is preferred. %>');
	text = text.replace(/(\b1 and higher\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "1 and later" is preferred. %>');
	text = text.replace(/(\b1 and lower\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "1 and earlier" is preferred. %>');
	text = text.replace(/(\b1 GB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "1&nbsp;GB" is preferred. %>');
	text = text.replace(/(\b1 KB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "1&nbsp;KB" is preferred. %>');
	text = text.replace(/(\b1 MB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "1&nbsp;MB" is preferred. %>');
	text = text.replace(/(\b1 or above\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "1 or later" is preferred. %>');
	text = text.replace(/(\b1 or below\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "1 or earlier" is preferred. %>');
	text = text.replace(/(\b1 or greater\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "1 or later" is preferred. %>');
	text = text.replace(/(\b1 or higher\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "1 or later" is preferred. %>');
	text = text.replace(/(\b1 or lower\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "1 or earlier" is preferred. %>');
	text = text.replace(/(\b1GB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "1&nbsp;GB" is preferred. %>');
	text = text.replace(/(\b1KB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "1&nbsp;KB" is preferred. %>');
	text = text.replace(/(\b2 and above\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "2 and later" is preferred. %>');
	text = text.replace(/(\b2 and below\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "2 and earlier" is preferred. %>');
	text = text.replace(/(\b2 and greater\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "2 and later" is preferred. %>');
	text = text.replace(/(\b2 and higher\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "2 and later" is preferred. %>');
	text = text.replace(/(\b2 and lower\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "2 and earlier" is preferred. %>');
	text = text.replace(/(\b2 GB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "2&nbsp;GB" is preferred. %>');
	text = text.replace(/(\b2 KB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "2&nbsp;KB" is preferred. %>');
	text = text.replace(/(\b2 MB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "2&nbsp;MB" is preferred. %>');
	text = text.replace(/(\b2 or above\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "2 or later" is preferred. %>');
	text = text.replace(/(\b2 or below\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "2 or earlier" is preferred. %>');
	text = text.replace(/(\b2 or greater\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "2 or later" is preferred. %>');
	text = text.replace(/(\b2 or higher\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "2 or later" is preferred. %>');
	text = text.replace(/(\b2 or lower\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "2 or earlier" is preferred. %>');
	text = text.replace(/(\b2012R2\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# The short version of "PAS for Windows 2012 R2" is "PASW 2012 R2". %>');
	text = text.replace(/(\b2GB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "2&nbsp;GB" is preferred. %>');
	text = text.replace(/(\b2KB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "2&nbsp;KB" is preferred. %>');
	text = text.replace(/(\b3 and above\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "3 and later" is preferred. %>');
	text = text.replace(/(\b3 and below\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "3 and earlier" is preferred. %>');
	text = text.replace(/(\b3 and greater\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "3 and later" is preferred. %>');
	text = text.replace(/(\b3 and higher\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "3 and later" is preferred. %>');
	text = text.replace(/(\b3 and lower\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "3 and earlier" is preferred. %>');
	text = text.replace(/(\b3 GB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "3&nbsp;GB" is preferred. %>');
	text = text.replace(/(\b3 KB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "3&nbsp;KB" is preferred. %>');
	text = text.replace(/(\b3 MB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "3&nbsp;MB" is preferred. %>');
	text = text.replace(/(\b3 or above\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "3 or later" is preferred. %>');
	text = text.replace(/(\b3 or below\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "3 or earlier" is preferred. %>');
	text = text.replace(/(\b3 or greater\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "3 or later" is preferred. %>');
	text = text.replace(/(\b3 or higher\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "3 or later" is preferred. %>');
	text = text.replace(/(\b3 or lower\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "3 or earlier" is preferred. %>');
	text = text.replace(/(\b3GB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "3&nbsp;GB" is preferred. %>');
	text = text.replace(/(\b3KB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "3&nbsp;KB" is preferred. %>');
	text = text.replace(/(\b3rd party\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Use third party (n) or third-party (adj) %>');
	text = text.replace(/(\b4 and above\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "4 and later" is preferred. %>');
	text = text.replace(/(\b4 and below\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "4 and earlier" is preferred. %>');
	text = text.replace(/(\b4 and greater\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "4 and later" is preferred. %>');
	text = text.replace(/(\b4 and higher\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "4 and later" is preferred. %>');
	text = text.replace(/(\b4 and lower\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "4 and earlier" is preferred. %>');
	text = text.replace(/(\b4 GB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "4&nbsp;GB" is preferred. %>');
	text = text.replace(/(\b4 KB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "4&nbsp;KB" is preferred. %>');
	text = text.replace(/(\b4 MB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "4&nbsp;MB" is preferred. %>');
	text = text.replace(/(\b4 or above\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "4 or later" is preferred. %>');
	text = text.replace(/(\b4 or below\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "4 or earlier" is preferred. %>');
	text = text.replace(/(\b4 or greater\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "4 or later" is preferred. %>');
	text = text.replace(/(\b4 or higher\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "4 or later" is preferred. %>');
	text = text.replace(/(\b4 or lower\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "4 or earlier" is preferred. %>');
	text = text.replace(/(\b4GB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "4&nbsp;GB" is preferred. %>');
	text = text.replace(/(\b4KB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "4&nbsp;KB" is preferred. %>');
	text = text.replace(/(\b5 and above\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "5 and later" is preferred. %>');
	text = text.replace(/(\b5 and below\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "5 and earlier" is preferred. %>');
	text = text.replace(/(\b5 and greater\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "5 and later" is preferred. %>');
	text = text.replace(/(\b5 and higher\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "5 and later" is preferred. %>');
	text = text.replace(/(\b5 and lower\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "5 and earlier" is preferred. %>');
	text = text.replace(/(\b5 GB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "5&nbsp;GB" is preferred. %>');
	text = text.replace(/(\b5 KB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "5&nbsp;KB" is preferred. %>');
	text = text.replace(/(\b5 MB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "5&nbsp;MB" is preferred. %>');
	text = text.replace(/(\b5 or above\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "5 or later" is preferred. %>');
	text = text.replace(/(\b5 or below\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "5 or earlier" is preferred. %>');
	text = text.replace(/(\b5 or greater\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "5 or later" is preferred. %>');
	text = text.replace(/(\b5 or higher\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "5 or later" is preferred. %>');
	text = text.replace(/(\b5 or lower\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "5 or earlier" is preferred. %>');
	text = text.replace(/(\b5GB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "5&nbsp;GB" is preferred. %>');
	text = text.replace(/(\b5KB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "5&nbsp;KB" is preferred. %>');
	text = text.replace(/(\b6 and above\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "6 and later" is preferred. %>');
	text = text.replace(/(\b6 and below\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "6 and earlier" is preferred. %>');
	text = text.replace(/(\b6 and greater\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "6 and later" is preferred. %>');
	text = text.replace(/(\b6 and higher\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "6 and later" is preferred. %>');
	text = text.replace(/(\b6 and lower\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "6 and earlier" is preferred. %>');
	text = text.replace(/(\b6 GB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "6&nbsp;GB" is preferred. %>');
	text = text.replace(/(\b6 KB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "6&nbsp;KB" is preferred. %>');
	text = text.replace(/(\b6 MB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "6&nbsp;MB" is preferred. %>');
	text = text.replace(/(\b6 or above\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "6 or later" is preferred. %>');
	text = text.replace(/(\b6 or below\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "6 or earlier" is preferred. %>');
	text = text.replace(/(\b6 or greater\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "6 or later" is preferred. %>');
	text = text.replace(/(\b6 or higher\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "6 or later" is preferred. %>');
	text = text.replace(/(\b6 or lower\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "6 or earlier" is preferred. %>');
	text = text.replace(/(\b6GB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "6&nbsp;GB" is preferred. %>');
	text = text.replace(/(\b6KB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "6&nbsp;KB" is preferred. %>');
	text = text.replace(/(\b7 and above\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "7 and later" is preferred. %>');
	text = text.replace(/(\b7 and below\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "7 and earlier" is preferred. %>');
	text = text.replace(/(\b7 and greater\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "7 and later" is preferred. %>');
	text = text.replace(/(\b7 and higher\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "7 and later" is preferred. %>');
	text = text.replace(/(\b7 and lower\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "7 and earlier" is preferred. %>');
	text = text.replace(/(\b7 GB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "7&nbsp;GB" is preferred. %>');
	text = text.replace(/(\b7 KB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "7&nbsp;KB" is preferred. %>');
	text = text.replace(/(\b7 MB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "7&nbsp;MB" is preferred. %>');
	text = text.replace(/(\b7 or above\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "7 or later" is preferred. %>');
	text = text.replace(/(\b7 or below\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "7 or earlier" is preferred. %>');
	text = text.replace(/(\b7 or greater\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "7 or later" is preferred. %>');
	text = text.replace(/(\b7 or higher\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "7 or later" is preferred. %>');
	text = text.replace(/(\b7 or lower\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "7 or earlier" is preferred. %>');
	text = text.replace(/(\b7GB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "7&nbsp;GB" is preferred. %>');
	text = text.replace(/(\b7KB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "7&nbsp;KB" is preferred. %>');
	text = text.replace(/(\b8 and above\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "8 and later" is preferred. %>');
	text = text.replace(/(\b8 and below\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "8 and earlier" is preferred. %>');
	text = text.replace(/(\b8 and greater\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "8 and later" is preferred. %>');
	text = text.replace(/(\b8 and higher\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "8 and later" is preferred. %>');
	text = text.replace(/(\b8 and lower\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "8 and earlier" is preferred. %>');
	text = text.replace(/(\b8 GB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "8&nbsp;GB" is preferred. %>');
	text = text.replace(/(\b8 KB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "8&nbsp;KB" is preferred. %>');
	text = text.replace(/(\b8 MB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "8&nbsp;MB" is preferred. %>');
	text = text.replace(/(\b8 or above\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "8 or later" is preferred. %>');
	text = text.replace(/(\b8 or below\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "8 or earlier" is preferred. %>');
	text = text.replace(/(\b8 or greater\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "8 or later" is preferred. %>');
	text = text.replace(/(\b8 or higher\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "8 or later" is preferred. %>');
	text = text.replace(/(\b8 or lower\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "8 or earlier" is preferred. %>');
	text = text.replace(/(\b8GB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "8&nbsp;GB" is preferred. %>');
	text = text.replace(/(\b8KB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "8&nbsp;KB" is preferred. %>');
	text = text.replace(/(\b9 and above\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "9 and later" is preferred. %>');
	text = text.replace(/(\b9 and below\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "9 and earlier" is preferred. %>');
	text = text.replace(/(\b9 and greater\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "9 and later" is preferred. %>');
	text = text.replace(/(\b9 and higher\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "9 and later" is preferred. %>');
	text = text.replace(/(\b9 and lower\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "9 and earlier" is preferred. %>');
	text = text.replace(/(\b9 GB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "9&nbsp;GB" is preferred. %>');
	text = text.replace(/(\b9 KB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "9&nbsp;KB" is preferred. %>');
	text = text.replace(/(\b9 MB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "9&nbsp;MB" is preferred. %>');
	text = text.replace(/(\b9 or above\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "9 or later" is preferred. %>');
	text = text.replace(/(\b9 or below\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "9 or earlier" is preferred. %>');
	text = text.replace(/(\b9 or greater\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "9 or later" is preferred. %>');
	text = text.replace(/(\b9 or higher\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "9 or later" is preferred. %>');
	text = text.replace(/(\b9 or lower\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "9 or earlier" is preferred. %>');
	text = text.replace(/(\b9GB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "9&nbsp;GB" is preferred. %>');
	text = text.replace(/(\b9KB\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "9&nbsp;KB" is preferred. %>');
	text = text.replace(/(\ba SQL\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "an SQL" is preferred. %>');
	text = text.replace(/(\baddon\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "add-on" is preferred. %>');
	text = text.replace(/(\bADFS\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We write "AD FS" per the Microsoft preference. %>');
	...
	text = text.replace(/(\bapp instance\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "application instance" is preferred. %>');
	text = text.replace(/(\bApp Manager\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Apps Manager" is preferred. %>');
	text = text.replace(/(\bapp runtime\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "PAS runtime" is preferred. %>');
	...
	text = text.replace(/(\bare using\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Consider replacing with just "use". %>');
	...
	text = text.replace(/(\bBump\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "update" is preferred. %>');
	text = text.replace(/(\bbumps\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "update" is preferred. %>');
	text = text.replace(/(\bBumps\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "update" is preferred. %>');
	...
	text = text.replace(/(\bcan't\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	...
	text = text.replace(/(\bcommand below\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "following command" is preferred. %>');
	...
	text = text.replace(/(\bControl-C\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Ctrl-C" is preferred. %>');
	text = text.replace(/(\bcould've\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bcouldn't\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	...
	text = text.replace(/(\bDevops\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "DevOps" is preferred. %>');
	text = text.replace(/(\bdidn't\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	...
	text = text.replace(/(\bdon't\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bDon't\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	...
	text = text.replace(/(\bElastic Runtime\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Write "PAS" instead if writing about software that is compatible with that. %>');
	text = text.replace(/(\benter in\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Consider shortening to just "enter". %>');
	text = text.replace(/(\benter the following\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Run" a command instead of "typing" or "entering" it. %>');
	...
	text = text.replace(/(\bERT\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Elastic Runtime" is preferred. Write "PAS" instead if writing about software that is compatible with that. %>');
	text = text.replace(/(\beveryone's\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bEveryone's\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	...
	text = text.replace(/(\bgonna\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	...
	text = text.replace(/(\bgotta\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	...
	text = text.replace(/(\bGUID\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "UUID" might be better here; it is the more popular industry term and is preferred for CredHub and BOSH. %>');
	text = text.replace(/(\bHAC\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "HA cluster" is preferred. %>');
	text = text.replace(/(\bhadn't\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bhankering\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "want" is preferred. %>');
	text = text.replace(/(\bHAproxy\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "HAProxy" is preferred. %>');
	text = text.replace(/(\bHaproxy\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "HAProxy" is preferred. %>');
	text = text.replace(/(\bhasn't\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bhaven't\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bhe'd\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bHe'd\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bhe'll\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bHe'll\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bhe's\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bHe's\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	...
	text = text.replace(/(\bI'd\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bI'll\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bI'm\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bI've\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	...
	text = text.replace(/(\bIPSec for PCF\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "IPsec for PCF" is preferred. %>');
	...
	text = text.replace(/(\bisn't\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	...
	text = text.replace(/(\bIt is recommended\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Specify the party that recommends (Pivotal, Cloud Foundry, etc). %>');
	text = text.replace(/(\bit'll\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bit's\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bIt's\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	...
	text = text.replace(/(\blet's\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bLet's\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	...
	text = text.replace(/(\bloggregator\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We call it "Loggregator" -- capitalized and without a preceding "the". %>');
	...
	text = text.replace(/(\bmight've\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bmin\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "minimum" is preferred. %>');
	text = text.replace(/(\bMin\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Minimum" is preferred. %>');
	text = text.replace(/(\bmin\.\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "minimum" is preferred. %>');
	text = text.replace(/(\bMin\.\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Minimum" is preferred. %>');
	text = text.replace(/(\bmustn't\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bnameserver\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "name server" is preferred. %>');
	text = text.replace(/(\bneedn't\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	...
	text = text.replace(/(\bNginx\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "nginx" is preferred. %>');
	text = text.replace(/(\bnot recommend\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Pivotal discourages" is preferred. %>');
	text = text.replace(/(\bnot recommended\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Pivotal discourages" is preferred. %>');
	...
	text = text.replace(/(\bOperations Manager\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Ops Manager" is preferred. %>');
	text = text.replace(/(\bOps Man\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Ops Manager" is preferred. %>');
	text = text.replace(/(\bops manager\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Ops Manager" is preferred. %>');
	text = text.replace(/(\bOps Manager Director\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "BOSH Director" is preferred. %>');
	text = text.replace(/(\bOpsMan\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Ops Manager" is preferred. %>');
	text = text.replace(/(\bOpsManager\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Ops Manager" is preferred. %>');
	text = text.replace(/(\borganisation\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "org" is preferred. %>');
	text = text.replace(/(\bOrganisation\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Org" is preferred. %>');
	text = text.replace(/(\borganisations\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "orgs" is preferred. %>');
	text = text.replace(/(\bOrganisations\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Orgs" is preferred. %>');
	text = text.replace(/(\borganization\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "org" is preferred. %>');
	text = text.replace(/(\borganizations\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "orgs" is preferred. %>');
	...
	text = text.replace(/(\bplease\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Do not use unless asking the reader to do you a favor, such as giving feedback. %>');
	text = text.replace(/(\bPlease\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Do not use unless asking the reader to do you a favor, such as giving feedback. %>');
	text = text.replace(/(\bplug-in\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "plugin" is preferred. %>');
	...
	text = text.replace(/(\bpop-up menu\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "pop-up" is preferred with "menu" omitted %>');
	text = text.replace(/(\bpopup\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "pop-up" is preferred. %>');
	...
	text = text.replace(/(\bPreprovisioned\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Pre-provisioned" is preferred. %>');
	text = text.replace(/(\bprerequisite\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Prerequisites are things that you have to do before carrying out procedures in a topic, such as installing software or carrying out other procedures. Requirements are things that you need before, after or during. %>');
	...
	text = text.replace(/(\brecommend against\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Pivotal discourages" is preferred. %>');
	text = text.replace(/(\brecommends against\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Pivotal discourages" is preferred. %>');
	...
	text = text.replace(/(\brefer to\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# If telling the reader to look somewhere else, use "see". %>');
	text = text.replace(/(\bRefer to\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# If telling the reader to look somewhere else, use "See". %>');
	text = text.replace(/(\brepo\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "repository" is preferred. %>');
	text = text.replace(/(\brequirement\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Prerequisites are things that you have to do before carrying out procedures in a topic, such as installing software or carrying out other procedures. Requirements are things that you need before, after or during. %>');
	text = text.replace(/(\brestoration\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We use "restore" as both a verb and a noun. %>');
	...
	text = text.replace(/(\bSecurity Assertion Markup Language\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We never spell out SAML. %>');
	text = text.replace(/(\bsecurity assertion markup language\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We never spell out SAML. %>');
	text = text.replace(/(\bservice broker API\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Service Broker API" is preferred. %>');
	text = text.replace(/(\bService Instance\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Only capitalize "service instance" when it is part of a title %>');
	...
	text = text.replace(/(\bshan't\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bshe'd\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bShe'd\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bshe'll\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bShe'll\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	...
	text = text.replace(/(\bSocks\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "SOCKS" is preferred. Do not spell it out, even on first use. %>');
	text = text.replace(/(\bsomebody's\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bSomebody's\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bsomeone's\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bSomeone's\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	...
	text = text.replace(/(\bSpring 0\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Spring Framework 0" is preferred. %>');
	text = text.replace(/(\bSpring 1\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Spring Framework 1" is preferred. %>');
	text = text.replace(/(\bSpring 2\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Spring Framework 2" is preferred. %>');
	text = text.replace(/(\bSpring 3\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Spring Framework 3" is preferred. %>');
	text = text.replace(/(\bSpring 4\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Spring Framework 4" is preferred. %>');
	text = text.replace(/(\bSpring 5\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Spring Framework 5" is preferred. %>');
	text = text.replace(/(\bSpring 6\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Spring Framework 6" is preferred. %>');
	text = text.replace(/(\bSpring 7\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Spring Framework 7" is preferred. %>');
	text = text.replace(/(\bSpring 8\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Spring Framework 8" is preferred. %>');
	text = text.replace(/(\bSpring 9\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Spring Framework 9" is preferred. %>');
	text = text.replace(/(\bSpring Cloud DataFlow\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Spring Cloud Data Flow" is preferred. %>');
	text = text.replace(/(\bSpring framework 0\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Spring Framework 0" is preferred. %>');
	text = text.replace(/(\bSpring framework 1\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Spring Framework 1" is preferred. %>');
	text = text.replace(/(\bSpring framework 2\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Spring Framework 2" is preferred. %>');
	text = text.replace(/(\bSpring framework 3\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Spring Framework 3" is preferred. %>');
	text = text.replace(/(\bSpring framework 4\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Spring Framework 4" is preferred. %>');
	text = text.replace(/(\bSpring framework 5\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Spring Framework 5" is preferred. %>');
	text = text.replace(/(\bSpring framework 6\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Spring Framework 6" is preferred. %>');
	text = text.replace(/(\bSpring framework 7\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Spring Framework 7" is preferred. %>');
	text = text.replace(/(\bSpring framework 8\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Spring Framework 8" is preferred. %>');
	...
	text = text.replace(/(\bstrongly\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# This should probably be cut, especially if it precedes "recommend". %>');
	...
	text = text.replace(/(\btext field\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We prefer just "field". %>');
	text = text.replace(/(\btextbox\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "field" is preferred. %>');
	text = text.replace(/(\bthat'll\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bThat'll\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bthat's\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bThat's\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bthe Apps Manager\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We call it just "Apps Manager" -- there is no preceding "the". %>');
	...
	text = text.replace(/(\bthe Loggregator\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We call it "Loggregator" -- capitalized and without a preceding "the". %>');
	...
	text = text.replace(/(\bThere's\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bthey'd\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bThey'd\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bthey'll\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bThey'll\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bthey're\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bThey're\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bthey've\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bThey've\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bthrice\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "three times" is preferred. %>');
	text = text.replace(/(\bto login\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We use "login" (n) and "log in" (v). %>');
	...
	text = text.replace(/(\btype the following\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "Run" a command instead of "typing" or "entering" it. %>');
	...
	text = text.replace(/(\bwasn't\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bwe recommend\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Specify the party that recommends (Pivotal, Cloud Foundry, etc). %>');
	text = text.replace(/(\bWe recommend\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Specify the party that recommends (Pivotal, Cloud Foundry, etc). %>');
	text = text.replace(/(\bwe'd\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bWe'd\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bwe'll\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bWe'll\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bwe're\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bWe're\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bwe've\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bWe've\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	...
	text = text.replace(/(\bweren't\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bwhat's\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bWhat's\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bwhitelist\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Write "allow list" instead, unless "whitelist" is baked into the product. %>');
	text = text.replace(/(\bwho'll\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bwho's\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bwill\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Avoid "will" as we prefer the present tense. %>');
	text = text.replace(/(\bwish\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "want" is preferred. %>');
	text = text.replace(/(\bwon't\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bwould\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# Re-phrase for present tense if possible. %>');
	text = text.replace(/(\bwouldn't\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bwrite down\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "record" is preferred. %>');
	text = text.replace(/(\by'all\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bY'all\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bYaml\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "YAML" is preferred. %>');
	text = text.replace(/(\byaml\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "YAML" is preferred. %>');
	text = text.replace(/(\bYML file\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# "YAML file" is preferred. %>');
	text = text.replace(/(\byou might want\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# If possible, replace with "Pivotal recommends" or re-phrase as a mandate. %>');
	text = text.replace(/(\byou'd\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bYou'd\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\byou'll\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bYou'll\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\byou're\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bYou're\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\byou've\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
	text = text.replace(/(\bYou've\b(?![^£]*\<%# ECS %\>))/gm,'$1<%# We do not use contractions. %>');
