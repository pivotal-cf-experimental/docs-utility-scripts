...
function doreplacement(text)
{
  ...
  text = text.replace(/(^(?!\n)\s+(```|<\/code>|<\/pre>)\n(\s{0}|\s{7,})Where\b)/gm,'$1<%# Indent |Where| the same number of spaces as the closing code tag.  %>');
  text = text.replace(/(^(?!\n)\s+\d\.[^\:]*:\n\n(\s{0,5}|\s{7,})(?=(```|\<pre|\<code)))/gm,'$1<%# Indent the code snippet beneath this nested step 6 spaces. %>');
  text = text.replace(/(^\d\.[^\n]*\n\n(\s{0,3}|\s{5,})(?=(```|\<pre|\<code)))/gm,'$1<%# Indent the code snippet beneath this step 4 spaces. %>');
  ...
  text = text.replace(/(<%# £SCS %>```[^`]*[A-Z][A-Z]+[^`]*```<%# ECS %>(?![\n\s]*Where))/gm,'$1<%# Define any non-obvious placeholders present in the code snippet in the style of |Where PLACEHOLDER is...| %>');
  text = text.replace(/(^(?!(title:|owner:)).*2012R2(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# The short product name is #{vars.windows_runtime_abbr} 2012 R2. %>');
  text = text.replace(/(^(?!(title:|owner:)).*app runtime(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.app_runtime_full} %>');
  text = text.replace(/([^a][^l][\n\s]Compliance Scanner(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_short} %>');
  text = text.replace(/([^a][^l][\n\s]Concourse(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_short} %>');
  text = text.replace(/(^(?!(title:|owner:)).*Dev Connect(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_short} %>');
  text = text.replace(/(^(?!(title:|owner:)).*devconnect(?![^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use <%= vars.product_short %>');
  text = text.replace(/(^(?!(title:|owner:)).*Devconnect(?![^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use <%= vars.product_short %>');
  text = text.replace(/(^(?!(title:|owner:)).*DevConnect(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_short} %>');
  text = text.replace(/(^(?!(title:|owner:)).*devconnect(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_short} %>');
  text = text.replace(/(^(?!(title:|owner:)).*Devconnect(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_short} %>');
  text = text.replace(/([^a][^l][\n\s]Developer Console(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_short} %>');
  text = text.replace(/(^(?!(title:|owner:)).*Elastic Runtime(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.app_runtime_full} %>');
  text = text.replace(/(^(?!(title:|owner:)).*\bERT(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.app_runtime_full} %>');
  ...
  text = text.replace(/(^(?!(title:|owner:)).*IPSec for PCF(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_full} %>');
  text = text.replace(/([^a][^l][\n\s]Isolation Segment(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_short} %>');
  text = text.replace(/(^(?!(title:|owner:)).*MySQL for Pivotal Platform(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_full} %>');
  ...
  text = text.replace(/([^a][^l][\n\s]On-Demand Services SDK(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_short} %>');
  text = text.replace(/([^a][^l][\n\s]on-demand services SDK(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_short} %>');
  text = text.replace(/(^(?!(title:|owner:)).*Operations Manager(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.ops_manager} %>');
  text = text.replace(/(^(?!(title:|owner:)).*Ops Man\b(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.ops_manager} %>');
  text = text.replace(/([^a][^l][\n\s]Ops Manager(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.ops_manager} %>');
  text = text.replace(/(^(?!(title:|owner:)).*ops manager(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.ops_manager} %>');
  text = text.replace(/(^(?!(title:|owner:)).*OpsMan\b(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.ops_manager} %>');
  text = text.replace(/(^(?!(title:|owner:)).*OpsManager(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.ops_manager} %>');
  text = text.replace(/(\bopsmanager(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.ops_manager} %>');
  text = text.replace(/(^(?!(title:|owner:)).*PAS(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.app_runtime_abbr} %>');
  text = text.replace(/(^(?!(title:|owner:)).*PBS(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_short} %>');
  text = text.replace(/(^(?!title:|.*for).*PCF(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.platform_old} %>');
  text = text.replace(/(\bPDC(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_abbr} %>');
  text = text.replace(/(^(?!(title:|owner:)).*PFS(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_short} %>');
  text = text.replace(/(\bPivNet(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_network} %>');
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal Anti-Virus(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_full} %>');
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal App Service(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.app_runtime_full} %>');
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal app service(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.app_runtime_full} %>');
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal Application Service(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.app_runtime_full} %>');
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal application service(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.app_runtime_full} %>');
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal Backup and Restore(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_full} %>');
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal Cloud Foundry 3(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# #{platform_name} 3 is preferred. %>');
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal Cloud Foundry(?! 3)(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.platform_old} %>');
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal Compliance Scanner(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_full} %>');
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal Concourse(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_full} %>');
  text = text.replace(/(\bPivotal Container Service(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.k8s_runtime_full} %>');
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal CredHub Service Broker(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_full} %>');
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal Developer Console(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_full} %>');
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal Event Alerts(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_full} %>');
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal File Integrity Monitoring(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_full} %>');
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal GemFire(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_name} %>');
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal Greenplum(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_full} %>');
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal Healthwatch(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_full} %>');
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal IPsec(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_full} %>');
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal Isolation Segment(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_full} %>');
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal On Demand Services SDK(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_full} %>');
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal Ops Manager(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.ops_manager_full} %>');
  text = text.replace(/(^(?!title:|.*for\s).*Pivotal Platform(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.platform_name} %>');
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal Postgre[Ss](?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_full} %>');
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal Push Notification(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_full} %>');
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal RabbitMQ(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_full} %>');
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal Service Instance Manager(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_full} %>');
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal Single Sign-On(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_full} %>');
  ...
  text = text.replace(/(^(?!(title:|owner:)).*RabbitMQ \[Kubernetes\](?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_full} %>');
  text = text.replace(/(^(?!(title:|owner:)).*RabbitMQ &#91;Kubernetes&#93;(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_full} %>');
  text = text.replace(/(^(?!(title:|owner:)).*RabbitMQ for Kubernetes(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_short} %>');
  text = text.replace(/(^(?!(title:|owner:)).*RabbitMQ for Pivotal Platform(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_full} %>');
  text = text.replace(/(^(?!(title:|owner:)).*RabbitMQ for VMware Tanzu \[Kubernetes\](?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_full} %>');
  text = text.replace(/(^(?!(title:|owner:)).*RabbitMQ for VMware Tanzu &#91;Kubernetes&#93;(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_full} %>');
  text = text.replace(/(^(?!(title:|owner:)).*Redis for Pivotal Platform(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_full} %>');
  text = text.replace(/([^a][^l][\n\s]Service Instance Manager(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_short} %>');
  text = text.replace(/([^a][^l][\n\s]Single Sign-On(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_short} %>');
  text = text.replace(/(^(?!(title:|owner:)).*single sign-on(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_full} %>');
  text = text.replace(/([^\>] Installation Dashboard(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# #{vars.ops_manager} Installation Dashboard| is preferred. %>');
  text = text.replace(/([^\>] installation dashboard(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# #{vars.ops_manager} Installation Dashboard| is preferred. %>');
  text = text.replace(/(^(?!(title:|owner:)).*TAS(?! for)(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Depending on the product, use #{vars.app_runtime_abbr} or #{vars.windows_runtime_abbr}. %>');
  ...
  text = text.replace(/(^(?!(title:|owner:)).*TAS for VMs &#91;Windows&#93;(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{windows_runtime_abbr} %>');
  text = text.replace(/(^(?!(title:|owner:)).*TAS for VMs(?=([\.\n]| [^\[&]))(?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.app_runtime_abbr} %>');
  ...
  text = text.replace(/(^(?!(title:|owner:)).*VMware Tanzu SQL \[VMs\](?=[^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use #{vars.product_full} %>');
  ...
  text = text.replace(/(^(?!(title:|owner:)).*Beta\b(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# |beta| is preferred. %>');
  ...
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal application service(?![^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use <%= vars.app_runtime_full %>');
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal Backup and Restore(?![^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use <%= vars.product_full %>');
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal Cloud Foundry 3(?![^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# |<%= vars.platform_name %> 3| is preferred. %>');
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal Cloud Foundry(?! 3)(?![^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use <%= vars.platform_old %>');
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal Compliance Scanner(?![^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use <%= vars.product_full %>');
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal Concourse(?![^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use <%= vars.product_full %>');
  text = text.replace(/(^(?!(title:|owner:)).*Pivotal CredHub Service Broker(?![^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use <%= vars.product_full %>');
  ...
  text = text.replace(/(^(?!(title:|owner:)).*TAS for VMs \[Windows\](?![^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use <%= vars.windows_runtime_abbr %>');
  text = text.replace(/(^(?!(title:|owner:)).*TAS for VMs &#91;Windows&#93;(?![^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use <%= vars.windows_runtime_abbr %>');
  text = text.replace(/(^(?!(title:|owner:)).*TAS for VMs(?=([\.\n]| [^\[&]))(?![^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Use <%= vars.app_runtime_abbr %>');
  text = text.replace(/(^(?!(title:|owner:)).*TAS(?! for)(?![^\(]*\) %\>)(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# Depending on the product, use vars.app_runtime_abbr or vars.windows_runtime_abbr %>');
  ...
  text = text.replace(/(\bname of your choosing\b(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# |name you choose| is snappier and easier for machine translation. %>');
  ...
  text = text.replace(/(\bService-Gateway\b(?![^£]*\<%# ECS %\>)(?![^\{]*\}))/gm,'$1<%# |service-gateway| is preferred. %>');
