...
# `cd ~/workspace/#{repo}; git checkout 2.9; git checkout 12.42; git pull`
  `cd ~/workspace/#{repo}; git checkout 2.10; git checkout 13.5; git pull`
end
...
# `cd ~/workspace; git clone git@github.com:#{repo}.git; git checkout 2.9; git checkout 12.42; git pull`
  `cd ~/workspace; git clone git@github.com:#{repo}.git; git checkout 2.10; git checkout 13.5; git pull`
